...
const birthdayCounter = setInterval(() => {
  ...
  const hours = Math.floor(
    (reminDate % (1000 * 60 * 60 * 24)) / (1000 * 60 * 60)
  );
  ...
  if (reminDate < 0) {
    ...
    document.querySelector(".birthday-hint").innerHTML =
      "It's my birthday 🎊🎁🎈";
    document.querySelector(".birthday-time").innerHTML =
      "Oh my god, I'm delighted right now, this moment is one of the happiest moments I've ever got in my life.";
  }
}, 1000);
